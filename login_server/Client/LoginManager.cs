...
public class LoginManager : MonoBehaviour 
{
	...
	public void OnRemoteServerToggle(bool val)
	{
		isRemoteServer = val;
	}
	...
	private IEnumerator FindID()
	{
		...
		if(isRemoteServer)
			www = UnityWebRequest.Post("http://192.168.1.203:3000/forgot/id", form);
		else
			www = UnityWebRequest.Post("http://192.168.1.18:3000/forgot/id", form);
	...
	private IEnumerator FindPassword()
	{
		...
		if(isRemoteServer)
			www = UnityWebRequest.Post("http://192.168.1.203:3000/forgot/password", form);
		else
			www = UnityWebRequest.Post("http://192.168.1.18:3000/forgot/password", form);
	...
	private IEnumerator Login()
	{
		...
		if(isRemoteServer)
			www = UnityWebRequest.Post("http://192.168.1.203:3000/login", form);
		else
			www = UnityWebRequest.Post("http://192.168.1.18:3000/login", form);
...

	{
		if (isRegisterCheckEmail == true && isRegisterCheckID == true) 
		{
			...
			if(isRemoteServer)
				www = UnityWebRequest.Post("http://192.168.1.203:3000/register", form);
			else
				www = UnityWebRequest.Post("http://192.168.1.18:3000/register", form);
	...
	private IEnumerator RegisterEmailCheck()
	{
		...
		if(isRemoteServer)
			www = UnityWebRequest.Post("http://192.168.1.203:3000/register/overlap/email", form);
		else
			www = UnityWebRequest.Post("http://192.168.1.18:3000/register/overlap/email", form);
	...
	private IEnumerator RegisterIDCheck()
	{
		if (isRegisterCheckEmail == true) 
		{
			...
			if(isRemoteServer)
				www = UnityWebRequest.Post("http://192.168.1.203:3000/register/overlap/id", form);
			else
				www = UnityWebRequest.Post("http://192.168.1.18:3000/register/overlap/id", form);
